/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     10/19/2025 8:20:14 PM                        */
/*==============================================================*/
...
alter table TEACHER 
   drop foreign key FK_TEACHER_TEACHER_U_USER_ACC;
...
alter table TEACHER add constraint FK_TEACHER_TEACHER_U_USER_ACC foreign key (USER_ID)
      references USER_ACCOUNT (USER_ID) on delete restrict on update restrict;
